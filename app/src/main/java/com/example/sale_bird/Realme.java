...
public class Realme extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView phone_realme=findViewById(R.id.realme);
        AnimationDrawable animationDrawable=(AnimationDrawable)phone_realme.getDrawable();
            ...
            public void onClick(View v) {
                ...
                databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        if(Add.equals("-")){
                            startActivity(new Intent(Realme.this,Address.class));
                        }
                        else {
                            startActivity(new Intent(Realme.this,Order.class));
                        }
                    }

                    @Override
                    public void onCancelled(@NonNull DatabaseError databaseError) {
                        Toast.makeText(Realme.this, "Error"+databaseError.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
